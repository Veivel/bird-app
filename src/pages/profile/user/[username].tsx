...
import { HomeFeedContext, HOME_FEED } from '@/components/context/HomeFeedContext';
...
export default function PublicProfilePage():JSX.Element {
    ...
    const [targetProfile, setTargetProfile] = useState<USER_PROFILE | null>(null);
    ...
    return(
        <>
            <div>
                <div className='flex'>
                    { targetProfile ? <UserProfile {...targetProfile} /> : <UserProfile username={''} email={''} avatar={''} created_at={''} />}
                </div>
                <div>
                    <h1>Posts</h1>
                    {posts
                    ...
                    <div className='flex flex-col-reverse gap-y-4'>
                        ...
                        {posts.length === 0 ? <p>This user has no posts yet.</p> : <></>}
                    </div>
                        :
