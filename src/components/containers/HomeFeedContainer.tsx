...
import { useContext, BaseSyntheticEvent, useState } from 'react'
...
export default function HomeFeedContainer(): JSX.Element {
    const {
        ...
        pageNum,
        setPageNum,
    }: HOME_FEED = useContext(HomeFeedContext)
    ...
    function handleCFModal(e: BaseSyntheticEvent) {
        ...
        <>
            <div>
                <div className="flex flex-row-reverse justify-between">
                    <Button outline onClick={handleCFModal}>
                        <GroupIcon />
                        Edit Close Friends
                    </Button>
                </div>
                <h2 className="my-4">Post something to the world!</h2>
                ...
                {posts ? (
                    <>
                        ...
                        <InfiniteScroll
                            ...
                            endMessage={
                                <div className="flex">
                                    <Label className="mx-auto m-4 text-white">
